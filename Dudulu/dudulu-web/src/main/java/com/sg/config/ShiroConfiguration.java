...
public class ShiroConfiguration extends AbstractShiroWebFilterConfiguration {
    ...
    @Bean
    protected MyJwtGenerator jwtGenerator() {
        return new MyJwtGenerator(new SecretSignatureConfiguration(salt), new SecretEncryptionConfiguration(salt));
    }

    @Bean
    protected MyJwtAuthenticator jwtAuthenticator() {
        MyJwtAuthenticator jwtAuthenticator = new MyJwtAuthenticator();
    ...
    protected Clients clients(CasClient casClient, CasRestFormClient casRestFormClient) {
        ...
        //parameterClient.setParameterName("Authorization");
