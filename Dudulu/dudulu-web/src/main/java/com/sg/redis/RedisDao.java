...
//    private static Logger logger = Logger.getLogger(RedisUtil.class);
     ...
     * @return
     */
    public Set intersect(String key, List<String> strlist) {
        try {
            return redisTemplate.opsForSet().intersect(key, strlist);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
     ...
     * @return
     */
    public Object randomRemove(String key) {
        try {
     ...
     * @return
     */
    public boolean zAdd(String key, Object value, double socre) {
        try {
            Boolean add = redisTemplate.opsForZSet().add(key, value, socre);
            return add;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
